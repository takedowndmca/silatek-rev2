        ...
        <div class="md:grid grid-cols-2 gap-8">
            ...
            <div class="mb-4">
                        ...
                        <tbody>
                            @foreach (array_keys(config('layanan')[$layanan]['pdf']) as $pdf)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <a href="{{ route('wakil_dekan.surat.pdf', [$layanan, $pengajuan->uuid]) }}?jenis={{ $pdf }}"
                ...
                @if (!$pengajuan->surat->ttd)
                    <form action="{{ route('wakil_dekan.surat.terima', [$layanan, $pengajuan]) }}" method="post"
                        id="terimaPengajuan">
                        @csrf
                    ...
                    <form action="{{ route('wakil_dekan.surat.tolak', [$layanan, $pengajuan]) }}" method="post"
                        id="tolakPengajuan">
                        @csrf
