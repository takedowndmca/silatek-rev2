                        ...
                        <form action="{{ route('staf.layanan.terima', [$layanan, $pengajuan]) }}"
                            ...
                            <div class="p-4 overflow-y-auto">
                                ...
                                <div class="mb-3">
                                    ...
                                    <label for="tanggalUjianTutupInput"
                                        class="block text-sm font-medium mb-2">
                                    ...
                                    <input type="date"
                                        id="tanggalUjianTutupInput"
                                        name="tanggal_ujian_tutup"
                                        value="{{ old('tanggal_ujian_tutup') }}"
                                        class="py-2.5 sm:py-3 px-4 block w-full border border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500"
                                        required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="predikatInput"
                                        name="predikat_online"
                                        class="py-2.5 sm:py-3 px-4 block w-full border border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500"
                                        required>
                                        ...
                                        <option value="Pujian"
                                            @selected(old('predikat_online') == 'Pujian')>
                                            Pujian
                                        </option>

                                        <option value="Sangat Memuaskan"
                                            @selected(old('predikat_online') == 'Sangat Memuaskan')>
                                            Sangat Memuaskan
                                        </option>

                                        <option value="Memuaskan"
                                            @selected(old('predikat_online') == 'Memuaskan')>
                                            Memuaskan
                                        </option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <label for="judulPenelitianInput"
                                        class="block text-sm font-medium mb-2">
                                    ...
                                    <textarea id="judulPenelitianInput"
                                        ...
                                        required>{{ old('judul_penelitian') }}</textarea>
