@push('scripts')
    <script type="module">
        ...
        //
        // Pembimbing 1 tidak boleh dihapus
        // =========================================================
        ...
        function updateNomorPembimbing() {
            ...
            items.forEach((item, index) => {
                ...
                if (index === 0) {
                    ...
                    // Pembimbing 2 dst boleh dihapus
                    if (!tombolHapus) {
        ...
        function updateKetuaDariPembimbing() {
            ...
            if (pembimbing1) {
                ...
                // PENTING:
                // readonly tetap dikirim saat POST
        ...
        // =========================================================
        // KETIKA NAMA PEMBIMBING DIUBAH
        //
        // Kalau:
        // ☑ Ketua = Pembimbing 1
        //
        // maka nama Ketua otomatis ikut berubah.
        //
        // Begitu juga:
        // ☑ Sekretaris = Pembimbing 2
        // =========================================================
