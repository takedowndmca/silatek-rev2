        ...
        <div class="md:grid grid-cols-2 gap-8">
            ...
            <div class="mb-4">
                ...
                <div class="border border-gray-200 rounded-lg p-4 mb-5">
                    ...
                    @php
                        $dataIzinPenelitian = $pengajuan->data ?? [];
                    @endphp
                    ...
                    <div class="mb-3">
                        <span class="block text-sm font-medium text-gray-700">
                            Tujuan Surat / Nama Tempat Penelitian
                        </span>

                        <span class="block text-sm text-gray-600">
                            {{ data_get($dataIzinPenelitian, 'tujuan_penelitian', '-') }}
                        </span>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <span class="block text-sm text-gray-600 whitespace-pre-line">
                            {{ data_get($dataIzinPenelitian, 'alamat_penelitian', '-') }}
                        </span>
                    </div>
                                ...
                                <div class="p-4 overflow-y-auto">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('tujuan_penelitian', data_get($dataIzinPenelitian, 'tujuan_penelitian')) }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea id="alamat_penelitian"
                                            ...
                                            required>{{ old('alamat_penelitian', data_get($dataIzinPenelitian, 'alamat_penelitian')) }}</textarea>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea id="mahasiswa"
                                            name="mahasiswa"
                                            rows="3"
                                            class="py-2 px-3 sm:py-3 sm:px-4 block w-full border border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500"
                                            required>{{ old('mahasiswa') }}</textarea>

                                        <span class="text-gray-500 text-sm mt-1">
                                            Masukkan data mahasiswa dengan format
                                            (Nama / NIM) dan dipisahkan dengan baris baru.
                                        </span>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            id="judulSkripsiInput"
                                            name="judul_skripsi"
                                            value="{{ old('judul_skripsi', $pengajuan->judul ?? $pengajuan->judul_penelitian ?? '') }}"
                                            class="py-2.5 sm:py-3 px-4 block w-full border border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500"
                                            required>
