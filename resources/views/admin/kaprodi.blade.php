...
<x-layouts.dashboard title="Kaprodi">
    <div class="card">
        <div class="flex items-center justify-between mb-4">
            <h1 class="text-xl font-semibold text-gray-800">Daftar Kaprodi</h1>
            ...
            <div id="hs-offcanvas-right"
                ...
                <div class="flex justify-between items-center py-3 px-4 border-b border-gray-200 dark:border-neutral-700">
                    ...
                    <h3 id="hs-offcanvas-right-label"
                    ...
                    @foreach ($users as $user)
                        ...
                        <tr>
                            ...
                            <td class="whitespace-nowrap text-end text-sm font-medium">
                                ...
                                <button type="button"
                                    onclick="location.href = '{{ route('admin.kaprodi.edit', $user->id) }}'"
                                ...
                                <form action="{{ route('admin.kaprodi.destroy', $user->id) }}"
                                    method="post"
                                    class="inline">
